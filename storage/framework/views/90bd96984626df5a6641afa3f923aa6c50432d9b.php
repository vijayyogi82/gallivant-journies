            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <select class="form-select" name="vacationstyle">
               ...
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <select class="form-select" name="activitylevel">
                        <option value="activitylevel">1</option>
                        <option value="activitylevel">2</option>
                        <option value="activitylevel">3</option>
                        <option value="activitylevel">4</option>
                        <option value="activitylevel">5</option>
                        <option value="activitylevel">6</option>
                        <option value="activitylevel">7</option>
                        <option value="activitylevel">8</option>
                        <option value="activitylevel">9</option>
                        <option value="activitylevel">10</option>
                     </select>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <select class="form-select" name="groupsize">
                        <option value="groupsize">1</option>
                        <option value="groupsize">2</option>
                        <option value="groupsize">3</option>
                        <option value="groupsize">4</option>
                        <option value="groupsize">5</option>
                        <option value="groupsize">6</option>
                        <option value="groupsize">7</option>
                        <option value="groupsize">8</option>
                        <option value="groupsize">9</option>
                        <option value="groupsize">10</option>
                     </select>
                  </div>
               </div>
   ...
   <div id="collapseOne" class="accordion-collapse collapse show  d-lg-block" aria-labelledby="headingOne" data-bs-parent="#myTabContent">
      <div class="accordion-body">
         <div class="form-group">
            ...
            <textarea class="form-control summernote" name="overview"> <?php echo $tourcategory->overview; ?></textarea>
         </div>
         <div class="form-group">
            <label>Included</label>
            <textarea class="form-control summernote" name="included"><?php echo $tourcategory->included; ?></textarea>
         </div>
         <div class="form-group">
            <label>Not Included</label>
            <textarea class="form-control summernote" name="notincluded"><?php echo $tourcategory->notincluded; ?></textarea>
         </div>
...
<?php echo $__env->make('admin.layout.adminapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallivant-journeys/resources/views/admin/tourdetails/edit.blade.php ENDPATH**/ ?>