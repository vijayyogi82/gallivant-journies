...
<head>
	...
	<link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/vendors/font-awesome/css/font-awesome.css')); ?>">
	<!-- link to custom icomoon fonts -->
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/user/css/fonts/icomoon/icomoon.css')); ?>">
	<!-- link to wow js animation -->
	<link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/vendors/animate/animate.css')); ?>">
	<!-- include bootstrap css -->
	<link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/css/bootstrap.css')); ?>">
	<!-- include owl css -->
	<link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/vendors/owl-carousel/owl.carousel.css')); ?>">
	<link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/vendors/owl-carousel/owl.theme.css')); ?>">
	<!-- link to revolution css  -->
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/user/vendors/revolution/css/settings.css')); ?>">
	<!-- include main css -->
	<link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/css/main.css')); ?>">
    <link media="all" rel="stylesheet" href="<?php echo e(asset('assets/user/vendors/fancybox/jquery.fancybox.css')); ?>">
</head>
<body  id="body-padding">
	...
	<div id="wrapper">
		<div class="page-wrapper">
											...
											<div class="drop-holder">
												<div class="row">
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="hiking-camping.html"><img src="<?php echo e(asset('assets/user/img/generic/img-01.jpg" height="228" width="350" alt="image description')); ?>"></a>
															</div>
															<div class="des">
													...
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="jungle-safari.html"><img src="<?php echo e(asset('assets/user/img/generic/img-02.jpg" height="215" width="370" alt="image description')); ?>"></a>
															</div>
															<div class="des">
													...
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="city-tour.html"><img src="<?php echo e(asset('assets/user/img/generic/img-03.jpg" height="215" width="370" alt="image description')); ?>"></a>
															</div>
															<div class="des">
													...
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="family-fun.html"><img src="<?php echo e(asset('assets/user/img/generic/img-04.jpg" height="215" width="370" alt="image description')); ?>"></a>
															</div>
															<div class="des">
										...
										<div class="drop-wrap cart-wrap">
											...
											<ul class="cart-list">
												<li>
													<div class="img">
														<a href="#">
															<img src="<?php echo e(asset('assets/user/img/listing/img-16.jpg" height="165" width="170" alt="image description')); ?>">
														</a>
													</div>
												...
												<li>
													<div class="img">
														<a href="#">
															<img src="<?php echo e(asset('assets/user/img/listing/img-17.jpg" height="165" width="170" alt="image description')); ?>">
														</a>
													</div>
													<div class="text-holder">
												...
												<li>
													<div class="img">
														<a href="#">
															<img src="<?php echo e(asset('assets/user/img/listing/img-18.jpg" height="165" width="170" alt="image description')); ?>">
														</a>
													</div>
													<div class="text-holder">
														<span class="amount">x 4</span>
			...
			<!-- main banner -->
<?php /**PATH C:\xampp\htdocs\gallivant-journeys\resources\views/components/header.blade.php ENDPATH**/ ?>