...
<head>
    ...
    <link media="all" rel="stylesheet" href="<?php echo e(asset('assets/frontent/img/entrada.svg')); ?>">
...
<!-- Plugins css start-->
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/frontent/css/dashboard/select2.css')); ?>">
<!-- Plugins css Ends-->
<!-- Bootstrap css-->
...
<script src="<?php echo e(asset('assets/frontent/js/dashboardjs/bootstrap/bootstrap.min.js')); ?>"></script>
<!-- Plugins JS start-->
...
<!-- Plugin used-->
<script src="<?php echo e(asset('assets/frontent/js/dashboardjs/select2/select2.full.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/frontent/js/dashboardjs/select2/select2-custom.js')); ?>"></script>
...
<?php /**PATH /var/www/html/gallivant-journeys/resources/views/admin/layout/adminapp.blade.php ENDPATH**/ ?>