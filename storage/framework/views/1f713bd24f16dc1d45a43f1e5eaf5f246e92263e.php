...
<head>
	...
	<!-- favion -->
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('assets/user/img/user/logo-2.png')); ?>">
	<!-- link to font awesome -->
	<link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/vendors/font-awesome/css/font-awesome.css">
	<!-- link to custom icomoon fonts -->
	<link rel="stylesheet" type="text/css" href="https://updateproject.com/gallivant-journeys/public/assets/user/css/fonts/icomoon/icomoon.css">
	<!-- link to wow js animation -->
	<link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/vendors/animate/animate.css">
	<!-- include bootstrap css -->
	<link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/css/bootstrap.css">
	<!-- include owl css -->
	<link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/vendors/owl-carousel/owl.carousel.css">
	<link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/vendors/owl-carousel/owl.theme.css">
	<!-- link to revolution css  -->
	<link rel="stylesheet" type="text/css" href="https://updateproject.com/gallivant-journeys/public/assets/user/vendors/revolution/css/settings.css">
	<!-- include main css -->
	<link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/css/main.css">
    <link media="all" rel="stylesheet" href="https://updateproject.com/gallivant-journeys/public/assets/user/vendors/fancybox/jquery.fancybox.css">
</head>
<body>
	...
	<div id="wrapper">
		<div class="page-wrapper">
				...
				<div class="container-fluid">
					...
					<div class="logo">
						<a href="<?php echo e(Route('user.index')); ?>">
							<img class="normal" src="<?php echo e(asset('assets/user/img/user/logo-2.png')); ?>" alt="Entrada" style="position: relative;top: -36px;">
							<img class="gray-logo" src="<?php echo e(asset('assets/user/img/logos/logo.svg')); ?>" alt="Entrada">
						</a>
					</div>
					<!-- main navigation -->
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="nav">
							...
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo e(Route('tour_listing')); ?>">Tour Listing </a></li>
											...
											<div class="drop-holder">
												<div class="row">
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="hiking-camping.html"><img src="https://updateproject.com/gallivant-  journeys/public/assets/user/img/generic/img-01.jpg" height="228" width="350" alt="image description"></a>
															</div>
															<div class="des">
													...
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="jungle-safari.html"><img src="https://updateproject.com/gallivant-  journeys/public/assets/user/img/generic/img-02.jpg" height="215" width="370" alt="image description"></a>
															</div>
															<div class="des">
													...
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="city-tour.html"><img src="https://updateproject.com/gallivant- journeys/public/assets/user/img/generic/img-03.jpg" height="215" width="370" alt="image description"></a>
															</div>
															<div class="des">
													...
													<div class="col-sm-6 col-md-3">
														<div class="col">
															<div class="img-wrap">
																<a href="family-fun.html"><img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/generic/img-04.jpg" height="215" width="370" alt="image description"></a>
															</div>
															<div class="des">
										...
										<div class="drop-wrap cart-wrap">
											...
											<ul class="cart-list">
												<li>
													<div class="img">
														<a href="#">
															<img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/listing/img-16.jpg" height="165" width="170" alt="image description">
														</a>
													</div>
												...
												<li>
													<div class="img">
														<a href="#">
															<img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/listing/img-17.jpg" height="165" width="170" alt="image description">
														</a>
													</div>
													<div class="text-holder">
												...
												<li>
													<div class="img">
														<a href="#">
															<img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/listing/img-18.jpg" height="165" width="170" alt="image description">
														</a>
													</div>
													<div class="text-holder">
														<span class="amount">x 4</span>
			...
			<!-- main banner -->
<?php /**PATH /home/jatin/Desktop/All project/gallivant-journeys/resources/views/components/header.blade.php ENDPATH**/ ?>