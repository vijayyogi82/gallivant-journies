...
<div class="container-fluid">
   <div class="card">
      <div class="card-body">
      <form class="form-ad"  method="POST" action="<?php echo e(Route('tourdetail.update',$tourdetails->id)); ?>">
       <?php echo csrf_field(); ?>
       <?php echo method_field('PUT'); ?>
         <div class="row">
            <div class="col-md-4">
               <div class="mb-3">
                  <label>Title</label>
                  <input class="form-control" type="text" name="title" placeholder="" value="<?php echo e($tourdetails->title); ?>"/>
               </div>
            </div>
            <div class="col-md-4">
               <div class="mb-3">
                  <label>Price</label>
                  <input class="form-control" type="text"  name="price" placeholder="" value="<?php echo e($tourdetails->price); ?>"/>
               </div>
            </div>
            <div class="col-md-4">
               <div class="mb-3">
                  <label>Location</label>
                  <input class="form-control" type="text"  name="location" placeholder="" value="<?php echo e($tourdetails->location); ?>"/>
               </div>
            </div>
</div>
               ...
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <select class="form-select" name="activitylevel">
                        <option <?php echo e($tourdetails->recurring == '1' ? 'selected': ''); ?> value="1">1</option>
                        <option <?php echo e($tourdetails->recurring == '2' ? 'selected': ''); ?> value="2">2</option>
                         <option <?php echo e($tourdetails->recurring == '3' ? 'selected': ''); ?> value="3">3</option>
                         <option <?php echo e($tourdetails->recurring == '4' ? 'selected': ''); ?> value="4">4</option>
                        <option <?php echo e($tourdetails->recurring == '5' ? 'selected': ''); ?> value="5">5</option>
                         <option <?php echo e($tourdetails->recurring == '6' ? 'selected': ''); ?> value="6">6</option>
                         <option <?php echo e($tourdetails->recurring == '7' ? 'selected': ''); ?> value="7">7</option>
                         <option <?php echo e($tourdetails->recurring == '8' ? 'selected': ''); ?> value="8">8</option>
                         <option <?php echo e($tourdetails->recurring == '9' ? 'selected': ''); ?> value="9">9</option>
                         <option <?php echo e($tourdetails->recurring == '10' ? 'selected': ''); ?> value="10">10</option>
                     </select>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <select class="form-select" name="groupsize">
                       ...
                       <option <?php echo e($tourdetails->recurring == '2' ? 'selected': ''); ?> value="2">2</option>
                        ...
                        <option <?php echo e($tourdetails->recurring == '5' ? 'selected': ''); ?> value="5">5</option>
                       <option <?php echo e($tourdetails->recurring == '6' ? 'selected': ''); ?> value="6">6</option>
                       <option <?php echo e($tourdetails->recurring == '7' ? 'selected': ''); ?> value="7"></option>
                        <option <?php echo e($tourdetails->recurring == '8' ? 'selected': ''); ?> value="8">8</option>
                        <option <?php echo e($tourdetails->recurring == '9' ? 'selected': ''); ?> value="9">9</option>
                        <option <?php echo e($tourdetails->recurring == '10' ? 'selected': ''); ?> value="10">10</option>
                     </select>
   ...
   <div id="collapseOne" class="accordion-collapse collapse show  d-lg-block" aria-labelledby="headingOne" data-bs-parent="#myTabContent">
      <div class="accordion-body">
         <div class="form-group">
            ...
            <textarea class="form-control summernote" name="overview"><?php echo e($tourdetails->overview); ?></textarea>
         </div>
         <div class="form-group">
            <label>Included</label>
            <textarea class="form-control summernote" name="included"><?php echo e($tourdetails->included); ?></textarea>
         </div>
         <div class="form-group">
            <label>Not Included</label>
            <textarea class="form-control summernote" name="notincluded"> <?php echo e($tourdetails->notincluded); ?></textarea>
         </div>
...
<?php echo $__env->make('admin.layout.adminapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gallivant-journeys\resources\views/admin/tourdetails/edit.blade.php ENDPATH**/ ?>