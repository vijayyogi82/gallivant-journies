         ...
         <div class="row">
            ...
            <div class="col-lg-6">
               <ul class="payment-option">
                  <li>
                     <img src="<?php echo e(asset('assets/frontent/img/footer/visa.png')); ?>" alt="visa">
                  </li>
                  <li>
                     <img src="<?php echo e(asset('assets/frontent/img/footer/mastercard.png')); ?>" height="20" width="33" alt="master card">
                  </li>
                  <li>
                     <img src="<?php echo e(asset('assets/frontent/img/footer/paypal.png')); ?>" height="20" width="72" alt="paypal">
                  </li>
                  <li>
                     <img src="<?php echo e(asset('assets/frontent/img/footer/maestro.png')); ?>" height="20" width="33" alt="maestro">
                  </li>
                  <li>
                     <img src="<?php echo e(asset('assets/frontent/img/footer/bank-transfer.png')); ?>" height="20" width="55" alt="bank transfer">
                  </li>
               </ul>
            </div>
         </div>
...
</footer><?php /**PATH /var/www/html/gallivant-journeys/resources/views/components/footer.blade.php ENDPATH**/ ?>