                     ...
                     <div class="card-body">
                        <div class="row row-sm">
                           <div class="col-lg">
                              ...
                              <input class="form-control" name="title" type="text" value="<?php echo e($tourdetails->title); ?>">
                           </div>
                           <div class="col-lg mg-t-10 mg-lg-t-0">
                              <label for="validationTextarea" class="form-label">Price</label>
                              <input class="form-control" name="price" type="text" value="<?php echo e($tourdetails->price); ?>">
                           </div>
                           <div class="col-lg mg-t-10 mg-lg-t-0">
                        ...
                        <div class="row row-sm mg-t-20">
                           ...
                           <div class="col-lg mg-t-10 mg-lg-t-0">
                              ...
                              <select name="activitylevel" class="form-control select-lg select2">
                                 <option value="<?php echo e($tourdetails->activitylevel); ?>"><?php echo e($tourdetails->activitylevel); ?></option>
                           ...
                           <div class="col-lg mg-t-10 mg-lg-t-0">
                              ...
                              <select name="groupsize" class="form-control select-lg select2">
                                 <option value="<?php echo e($tourdetails->groupsize); ?>"><?php echo e($tourdetails->groupsize); ?></option>
                                 <option value="1">1</option>
                                 <option value="2">2</option>
                                 <option value="3">3</option>
                                 <option value="4">4</option>
                           ...
                           <div class="row row-sm mg-t-20">
                              <div class="col-lg mg-t-10 mg-lg-t-0">
                                 ...
                                 <img src="<?php echo e(asset('storage/tourdetai/'. $tourdetails->featured_image)); ?>" height="150px" , width="150px">
                              </div>
                           </div>
                        </div>
                     </div>
                                       ...
                                       <div class="card-body tab-content">
                                          ...
                                          <div class="tab-pane active show" id="overview">
                                             <div class="mb-3">
                                                ...
                                                <textarea class="form-control ckeditor" name="overview" value="<?php echo e($tourdetails->overview); ?>" id="summernote" placeholder="Required example textarea" required></textarea>
...
<?php echo $__env->make('admin.layout.adminapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/updateproject/public_html/gallivant-journeys/resources/views/admin/tourdetails/edit.blade.php ENDPATH**/ ?>