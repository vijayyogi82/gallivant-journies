					...
					<div class="container">
						<div id="two-columns" class="row">
							...
							<div id="content" class="col-md-8 col-lg-9">
								...
								<?php $__currentLoopData = $tour_listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour_listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
								...
								<article class="col-md-6 col-lg-4 article has-hover-s1 thumb-full">
									<div class="thumbnail">
										<div class="img-wrap">
											<img src="<?php echo e($tour_listing->featured_image); ?>" height="228" width="350" alt="image description">
										</div>
										<h3 class="small-space"><a href="<?php echo e(Route('tour_detail',['category_name'=>                                 $popularString_category,'tour_name'=>$popularString,'id'=>base64_encode($tour_listing->id) ])); ?>"><?php echo e($tour_listing->Tourcategory->title); ?></a></h3>
										<span class="info"><?php echo e($tour_listing->title); ?></span>
										<aside class="meta">
											<span class="country">
										...
										<p><?php echo e($tour_listing->overview); ?>.</p>
										<a href="<?php echo e(Route('tour_detail',['category_name'=>                                 $popularString_category,'tour_name'=>$popularString,'id'=>base64_encode($tour_listing->id) ])); ?>" class="btn btn-default">explore</a>
										<footer>
											...
											<span class="price">from <span><?php echo e($tour_listing->price); ?></span></span>
										</footer>
									</div>
								</article>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jatin/Desktop/All project/gallivant-journeys/resources/views/user/tour_listing.blade.php ENDPATH**/ ?>