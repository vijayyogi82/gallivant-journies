						...
						<form class="trip-form">
							<fieldset>
								<div class="holder">
									...
									<div class="select-holder">
										<select class="trip dark" id="adventure">
											...
											<option>4 Wheel Drives</option>
											<option>Hunting Fishing</option>
											<option>Discover Africa</option>
										</select>
									</div>
								</div>
								<div class="holder">
								...
								<div class="holder">
									...
									<div class="select-holder">
										<select class="trip dark" id="date">
						...
						<div class="content-holder">
							<div class="row db-3-col">
								<article class="col-sm-6 col-md-4 article has-hover-s3">
									<div class="img-wrap">
										<a href="#">
											<img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/listing/img-01.jpg" height="215" width="370" alt="image description">
										</a>
						...
						<div class="row same-height">
							<div class="col-md-6 image height wow slideInLeft">
								<div class="bg-stretch">
									<img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/img-01.jpg" height="627" width="960" alt="image description">
								</div>
							</div>
						...
						<div class="content-holder content-boxed">
							<div class="row db-3-col">
								<article class="col-sm-6 col-md-4 article has-hover-s1">
									<div class="thumbnail">
										<div class="img-wrap">
											<img src="https://updateproject.com/gallivant-journeys/public/assets/user/img/listing/img-07.jpg" height="228" width="350" alt="image description">
										</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/updateproject/public_html/gallivant-journeys/resources/views/index.blade.php ENDPATH**/ ?>