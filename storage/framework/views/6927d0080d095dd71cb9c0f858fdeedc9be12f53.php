						...
						<div class="row mg-t-50">
							...
							<div class="col-lg  ">
								...
								<h6 style=" padding-left: 93px;">
									<?php echo e($tourdetails ? $tourdetails->overview :''); ?>
					...
					<div class="card-body">
						<div class="row mg-t-50">
							...
							<div class="col-lg col-sm-4">
								<img src="<?php echo e(asset('storage/tourdetail/' . $gallary->image)); ?>" alt="Image" height="150px" , width="150px">
...
<?php echo $__env->make('admin.layout.adminapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/updateproject/public_html/gallivant-journeys/resources/views/admin/tourdetails/show.blade.php ENDPATH**/ ?>