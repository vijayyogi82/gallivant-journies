      ...
      <div id="rev_slider_70_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
         <ul>
            <li data-index="rs-81" data-transition="slideoverup" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="The Menu" data-description="">
               ...
               <img alt="image description" src="<?php echo e(asset('assets/frontent/img/banner/img-04.jpg')); ?>" height="1280" width="1920"  data-lazyload="<?php echo e(asset('assets/frontent/img/banner/img-04.jpg')); ?>" data-bgposition="right center" data-kenburns="on" data-duration="30000" data-ease="Power1.easeOut" data-scalestart="110" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
   ...
   <div class="banner-text">
      <div class="center-text">
         <form class="trip-form">
            <fieldset>
               <div class="holder">
                  <label for="category_id">Select Your Adventure</label>
                  <div class="select-holder">
                     <select class="trip dark" id="category_id" name ="category_id">
                        ...
                        <option value ="<?php echo e($Tourcategory->id); ?>"><?php echo e($Tourcategory->title); ?></option>
               ...
               <div class="holder">
                  <label for="location_id">Select Your Destination</label>
                  <div class="select-holder">
                     <select class="trip dark" id="location_id" name= "location_id">
                        ...
                        <option value ="<?php echo e($Tourlocation->id); ?>"><?php echo e($Tourlocation->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </select>
                  </div>
               </div>
               ...
               <div class="col-md-6 img-block">
                  ...
                  <ul class="gallery-list gallery-with-icon">
                     <li>
                        ...
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-01.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-02.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-03.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-04.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-05.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-06.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-07.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-08.jpg')); ?>" height="165" width="170" alt="image description">
                     ...
                     <li>
                        <a href="#" class="thumbnail">
                        <img src="<?php echo e(asset('assets/frontent/img/gallery/img-09.jpg')); ?>" height="165" width="170" alt="image description">
         ...
         <div class="content-holder">
            <div class="row db-3-col">
               <article class="col-sm-6 col-md-4 article has-hover-s3">
                  <div class="img-wrap">
                     <a href="#">
                     <img src="<?php echo e(asset('assets/frontent/img/listing/img-01.jpg')); ?>" height="215" width="370" alt="image description">
                     </a>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s3">
                  <div class="img-wrap">
                     <a href="#">
                     <img src="<?php echo e(asset('assets/frontent/img/listing/img-02.jpg')); ?>" height="215" width="370" alt="image description">
                     </a>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s3">
                  <div class="img-wrap">
                     <a href="#">
                     <img src="<?php echo e(asset('assets/frontent/img/listing/img-03.jpg')); ?>" height="215" width="370" alt="image description">
                     </a>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s3">
                  <div class="img-wrap">
                     <a href="#">
                     <img src="<?php echo e(asset('assets/frontent/img/listing/img-04.jpg')); ?>" height="215" width="370" alt="image description">
                     </a>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s3">
                  <div class="img-wrap">
                     <a href="#">
                     <img src="<?php echo e(asset('assets/frontent/img/listing/img-05.jpg')); ?>" height="215" width="370" alt="image description">
                     </a>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s3">
                  <div class="img-wrap">
                     <a href="#">
                     <img src="<?php echo e(asset('assets/frontent/img/listing/img-06.jpg')); ?>" height="215" width="370" alt="image description">
                     </a>
      ...
      <div class="container-fluid">
         <div class="row same-height">
            <div class="col-md-6 image height wow slideInLeft">
               <div class="bg-stretch">
                  <img src="<?php echo e(asset('assets/frontent/img/img-01.jpg')); ?>" height="627" width="960" alt="image description">
               </div>
            </div>
         ...
         <div class="row same-height">
            <div class="col-md-6 image height wow slideInRight">
               <div class="bg-stretch">
                  <img src="<?php echo e(asset('assets/frontent/img/img-02.jpg')); ?>" height="627" width="960" alt="image description">
               </div>
            </div>
         ...
         <div class="content-holder content-boxed">
            <div class="row db-3-col">
               <article class="col-sm-6 col-md-4 article has-hover-s1">
                  <div class="thumbnail">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-07.jpg')); ?>" height="228" width="350" alt="image description">
                     </div>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s1">
                  <div class="thumbnail">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-08.jpg')); ?>" height="228" width="350" alt="image description">
                     </div>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s1">
                  <div class="thumbnail">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-09.jpg')); ?>" height="228" width="350" alt="image description">
                     </div>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s1">
                  <div class="thumbnail">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-10.jpg')); ?>" height="228" width="350" alt="image description">
                     </div>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s1">
                  <div class="thumbnail">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-11.jpg')); ?>" height="228" width="350" alt="image description">
                     </div>
               ...
               <article class="col-sm-6 col-md-4 article has-hover-s1">
                  <div class="thumbnail">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-12.jpg')); ?>" height="228" width="350" alt="image description">
                     </div>
         ...
         <div class="content-holder">
            <div class="row">
               <div class="col-sm-6 col-md-4 img-article">
                  <div class="holder">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-13.jpg')); ?>" height="436" width="370" alt="image description">
                        <ul class="social-networks">
                           <li><a href="#"><span class="icon-facebook"></span></a></li>
                           <li><a href="#"><span class="icon-twitter"></span></a></li>
                           <li><a href="#"><span class="icon-google-plus"></span></a></li>
               ...
               <div class="col-sm-6 col-md-4 img-article">
                  <div class="holder">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-14.jpg')); ?>" height="436" width="370" alt="image description">
                        <ul class="social-networks">
                           <li><a href="#"><span class="icon-facebook"></span></a></li>
                           <li><a href="#"><span class="icon-twitter"></span></a></li>
                           <li><a href="#"><span class="icon-google-plus"></span></a></li>
               ...
               <div class="col-sm-6 col-md-4 img-article">
                  <div class="holder">
                     <div class="img-wrap">
                        <img src="<?php echo e(asset('assets/frontent/img/listing/img-15.jpg')); ?>" height="436" width="370" alt="image description">
                        <ul class="social-networks">
                           <li><a href="#"><span class="icon-facebook"></span></a></li>
                           <li><a href="#"><span class="icon-twitter"></span></a></li>
                           <li><a href="#"><span class="icon-google-plus"></span></a></li>
         ...
         <div id="testimonial-home-slide">
            <div class="slide">
               <blockquote class="testimonial-quote">
                  <div class="img">
                     <img src="<?php echo e(asset('assets/frontent/img/thumbs/img-01.jpg')); ?>" height="112" width="112" alt="image description">
                  </div>
                  <div class="text">
            ...
            <div class="slide">
               <blockquote class="testimonial-quote">
                  <div class="img">
                     <img src="<?php echo e(asset('assets/frontent/img/thumbs/img-02.jpg')); ?>" height="112" width="112" alt="image description">
                  </div>
                  <div class="text">
            ...
            <div class="slide">
               <blockquote class="testimonial-quote">
                  <div class="img">
                     <img src="<?php echo e(asset('assets/frontent/img/thumbs/img-03.jpg')); ?>" height="112" width="112" alt="image description">
                  </div>
                  <div class="text">
   ...
   <article class="partner-block">
      <div class="container">
         ...
         <div class="partner-list" id="partner-slide">
            <div class="partner">
               <a href="#">
               <img width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-travelagancy.svg')); ?>" alt="image description">
               <img class="hover" width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-travelagancy-hover.svg')); ?>" alt="image description">
               </a>
            </div>
            <div class="partner">
               <a href="#">
               <img width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-around-world.svg')); ?>" alt="image description">
               <img class="hover" width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-around-world-hover.svg')); ?>" alt="image description">
               </a>
            </div>
            <div class="partner">
               <a href="#">
               <img width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-tourist.svg')); ?>" alt="image description">
               <img class="hover" width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-tourist-hover.svg')); ?>" alt="image description">
               </a>
            </div>
            <div class="partner">
               <a href="#">
               <img width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-adventure.svg')); ?>" alt="image description">
               <img class="hover" width="130" src="<?php echo e(asset('assets/frontent/img/logos/logo-adventure-hover.svg')); ?>" alt="image description">
               </a>
            </div>
            <div class="partner">
               <a href="#">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallivant-journeys/resources/views/index.blade.php ENDPATH**/ ?>