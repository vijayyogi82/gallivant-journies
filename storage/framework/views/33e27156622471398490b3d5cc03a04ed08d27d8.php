...
<header id="header" class="white-header">
   <div class="container-fluid">
      ...
      <div class="logo">
         <a href="index.html">
         <img class="normal" src="<?php echo e(asset('assets/frontent/img/logos/logo.svg')); ?>" alt="Entrada">
         <img class="gray-logo" src="<?php echo e(asset('assets/frontent/img/logos/logo-gray.svg')); ?>" alt="Entrada">
         </a>
      </div>
      <!-- main navigation -->
                        ...
                        <div class="drop-holder">
                           <div class="row">
                              <div class="col-sm-6 col-md-3">
                                 <div class="col">
                                    <div class="img-wrap">
                                       <a href="hiking-camping.html"><img src="<?php echo e(asset('assets/frontent/img/generic/img-01.jpg')); ?>" height="228" width="350" alt="image description"></a>
                                    </div>
                                    <div class="des">
                              ...
                              <div class="col-sm-6 col-md-3">
                                 <div class="col">
                                    <div class="img-wrap">
                                       <a href="jungle-safari.html"><img src="<?php echo e(asset('assets/frontent/img/generic/img-02.jpg')); ?>" height="215" width="370" alt="image description"></a>
                                    </div>
                                    <div class="des">
                              ...
                              <div class="col-sm-6 col-md-3">
                                 <div class="col">
                                    <div class="img-wrap">
                                       <a href="city-tour.html"><img src="<?php echo e(asset('assets/frontent/img/generic/img-03.jpg')); ?>" height="215" width="370" alt="image description"></a>
                                    </div>
                                    <div class="des">
                              ...
                              <div class="col-sm-6 col-md-3">
                                 <div class="col">
                                    <div class="img-wrap">
                                       <a href="family-fun.html"><img src="<?php echo e(asset('assets/frontent/img/generic/img-04.jpg')); ?>" height="215" width="370" alt="image description"></a>
                                    </div>
                                    <div class="des">
                     ...
                     <div class="drop-wrap cart-wrap">
                        ...
                        <ul class="cart-list">
                           <li>
                              <div class="img">
                                 <a href="#">
                                 <img src="<?php echo e(asset('assets/frontent/img/listing/img-16.jpg')); ?>" height="165" width="170" alt="image description">
                                 </a>
                              </div>
                           ...
                           <li>
                              <div class="img">
                                 <a href="#">
                                 <img src="<?php echo e(asset('assets/frontent/img/listing/img-17.jpg')); ?>" height="165" width="170" alt="image description">
                                 </a>
                              </div>
                              <div class="text-holder">
                           ...
                           <li>
                              <div class="img">
                                 <a href="#">
                                 <img src="<?php echo e(asset('assets/frontent/img/listing/img-18.jpg')); ?>" height="165" width="170" alt="image description">
                                 </a>
                              </div>
                              <div class="text-holder">
                                 <span class="amount">x 4</span>
...
<!-- main container --><?php /**PATH /var/www/html/gallivant-journeys/resources/views/components/header.blade.php ENDPATH**/ ?>