...
<footer id="footer">
	<div class="container">
		...
		<ul class="social-wrap">
			<li class="facebook"><a target="_blank" href="{{$Socialmedia_facebook->platform_url}}">
			...
			<li class="google-plus"><a href="{{$Socialmedia_google->platform_url}}">
					<span class="icon-google-plus"></span>
					<strong class="txt">+1 On Google</strong>
				</a>
			</li>
			<li class="instagram"><a target="_blank" href="{{$Socialmedia_instagram->platform_url}}">
					<span class="ins"></span>
