	...
	<div class="container">
		<div class="main-header-left">
			...
			<a class="main-logo" href="index.html">
				<img src="{{asset('assets/user/img/user/logo-2.png')}}" class="header-brand-img desktop-logo" alt="logo" style="height: 65px;">
				<img src=".{{asset('assets/user/img/user/logo-2.png')}}" class="header-brand-img desktop-logo theme-logo" alt="logo">
			</a>
		</div>
		...
		<div class="main-header-right">
			...
			<div class="dropdown main-profile-menu">
				<a class="d-flex" href="">
					<span class="main-img-user" ><img alt="avatar" src="{{asset('assets/Admin/assets/img/users/1.jpg')}}"></span>
				</a>
				<div class="dropdown-menu">
					<div class="header-navheading">
...
<div class="main-navbar hor-menu sticky">
	<div class="container">
		<ul class="nav">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{URL('admin/tourcategory')}}"><i class="fa-solid fa-chess"></i>Tour Category</a>
			</li>
			<li class="nav-item">
				<a class="nav-link " href="{{URL('admin/tourlocation')}}"><i class="fas fa-map-marker-alt"></i>Tour Location</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="{{URL('admin/tourdetail')}}"><i class="ti-write"></i>Tour Details</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="{{URL('admin/socialmedia')}}"><i class="ti-write"></i>Social Media</a>
			</li>
