   ...
   <section class="container-fluid trip-info">
      <div class="same-height two-columns row">
            ...
            <div id="tour-slide">
               <div class="slide">
                  <div class="bg-stretch">
                     <img src="{{$tour_detail->featured_image}}" alt="image descriprion" height="1104" width="966">
                  </div>
               </div>
               <div class="slide">
                  <div class="bg-stretch">
         ...
         <div class="height col-md-6 text-col">
            <div class="holder">
               <h1 class="small-size">{{$tour_detail->title}}</h1>
               <div class="price">
                  from <strong>{{$tour_detail->price}} ₹</strong>
               </div>
               <div class="description">
                  <p>{{$tour_detail->overview}}</p>
               </div>
               <ul class="reviews-info">
                  ...
                  <li>
                     ...
                     <div class="info-right">
                        ...
                        <span class="value">{{$tour_detail->Tourcategory->title}}</span>
                     </div>
                  </li>
                  <li>
                     <div class="info-left">
                     ...
                     <div class="info-right">
                        ...
                        <span class="value">{{$tour_detail->activitylevel}}/10</span>
                     </div>
                  </li>
                  <li>
                     <div class="info-left">
                     ...
                     <div class="info-right">
                        ...
                        <span class="value">{{$tour_detail->groupsize}}/10</span>
                     </div>
                  </li>
               </ul>
               <!--  -->
   ...
   <div class="tab-container">
      ...
      <div class="container tab-content trip-detail">
         ...
         <div role="tabpanel" class="tab-pane active" id="tab01">
            <div class="row">
               <div class="col-md-6">
                  <strong class="header-box">All about the {{$category}}</strong>
                  <div class="detail">
                     <p>{{$tour_detail->overview}}</p>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <ol class="detail-accordion">
                     @foreach($Tourdetail_itinerarys as $Tourdetail_itinerary)
                     <li class="">
                        <a href="#">
                           <strong class="title">{{$Tourdetail_itinerary->days}}</strong>
                           <span>Return to London</span>
                        </a>
                        <div class="slide">
                           <div class="slide-holder">
                              <p>{{$Tourdetail_itinerary->description}}</p>
                           </div>
                        </div>
                     </li>
                     @endforeach
               ...
               <div class="col-md-6">
                  @foreach($Tourdetail_gallary_itinerarys as $Tourdetail_gallary_itinerary)
                  <article class="img-article article-light">
                     <div class="img-wrap">
                        <img src="{{$Tourdetail_gallary_itinerary->image}}" alt="image description">
                     </div>
         ...
         <div role="tabpanel" class="tab-pane" id="tab05">
            <ul class="row gallery-list has-center">
               @foreach($Tourdetail_gallarys as $Tourdetail_gallary)
               <li class="col-sm-6">
                  <a class="fancybox" data-fancybox-group="group" href="img/gallery/img-10-2.jpg" title="Caption Goes Here">
                     <span class="img-holder">
                        <img src="{{$Tourdetail_gallary->image}}" alt="image description" style="height: 250px;">
                     </span>
                     <span class="caption">
                        <span class="centered">
                           <strong class="title">{{$category}}</strong>
                           <span class="sub-text">{{$tour}}</span>
                        </span>
                     </span>
                  </a>
               </li>
            ...
            <div class="table-container">
               <div class="table-responsive">
                  <table class="table table-striped">
                     ...
                     <tbody>
                        @foreach($Tourdetail_departures as $Tourdetail_departure)
                        <tr>
                           <td>
                              <div class="cell">
                                 <div class="middle">{{ \Carbon\Carbon::parse($Tourdetail_departure->departure_date)->format('d-M-Y') }}</div>
                              </div>
                           </td>
                           <td>
                              <div class="cell">
                                 <div class="middle">{{ $Tourdetail_departure->price}} </div>
                              </div>
                           </td>
                           <td>
                              <div class="cell">
