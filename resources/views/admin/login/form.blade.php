...
<html lang="en">
	<head>
		...
		<!-- Color css-->
		<link id="theme" rel="stylesheet" type="text/css" media="all" href="{{asset('assets/Admin/assets/css/colors/color5.css')}}">
	...
	<body class="main-body leftmenu">
		...
		<!-- <div id="global-loader">
			<img src="{{asset('assets/user/img/user/logo-2.png')}}" class="loader-img" alt="Loader">
		</div> -->
		<!-- End Loader -->
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute">
									<img src="{{asset('assets/user/img/user/logo-2.png')}}" class="header-brand-img mb-4" alt="logo" style=" height:130px;">
									<div class="clearfix"></div>
									<img src="{{asset('assets/Admin/assets/img/svgs/user.svg')}}" class="ht-100 mb-0" alt="user">
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<div class="clearfix"></div>
											<form class="theme-form login-form" action="{{ route('adminlogin') }}" method ="POST">
                                                @csrf
