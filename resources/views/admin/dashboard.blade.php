									...
									<div class="card bg-primary custom-card card-box">
										<div class="card-body p-4">
											<div class="row align-items-center">
												...
												<img src="{{asset('assets/Admin/assets/img/pngs/work3.png')}}" alt="user-img">
											</div>
										</div>
									</div>
								</div>
													...
													<tbody>
															...
															<td class="text-nowrap">
																<div class="demo-avatar-group my-auto float-end">
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/1.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/2.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/3.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/4.jpg')}}">
																	</div>
																</div>
															</td>
														...
														<tr>
															...
															<td class="text-nowrap">
																<div class="demo-avatar-group my-auto float-end">
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/5.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/6.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/7.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/8.jpg')}}">
																	</div>
																</div>
															</td>
															<td class="text-center">37<i class=""></i></td>
														...
														<tr>
															...
															<td class="text-nowrap">
																<div class="demo-avatar-group my-auto float-end">
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/11.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/12.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/9.jpg')}}">
																	</div>
																	<div class="main-img-user avatar-sm">
																		<img alt="avatar" class="rounded-circle" src="{{asset('assets/Admin/assets/img/users/10.jpg')}}">
																	</div>
																</div>
															</td>
															<td class="text-center">37<i class=""></i></td>
								...
								<table class="table table-hover m-b-0 transcations mt-2">
									<tbody>
										<tr>
											<td class="wd-5p">
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="rounded-circle me-3" src="{{asset('assets/Admin/assets/img/users/5.jpg')}}">
												</div>
											</td>
											<td>
										 ...
										 <tr>
											<td class="wd-5p">
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="rounded-circle me-3" src="{{asset('assets/Admin/assets/img/users/6.jpg')}}">
												</div>
											</td>
											<td>
												<div class="d-flex align-middle ms-3">
										...
										<tr>
											<td class="wd-5p">
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="rounded-circle me-3" src="{{asset('assets/Admin/assets/img/users/7.jpg')}}">
												</div>
											</td>
											<td>
												<div class="d-flex align-middle ms-3">
										...
										<tr>
											<td class="wd-5p">
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="rounded-circle me-3" src="{{asset('assets/Admin/assets/img/users/8.jpg')}}">
												</div>
											</td>
											<td>
												<div class="d-flex align-middle ms-3">
										...
										<tr>
											<td class="wd-5p pb-0">
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="rounded-circle me-3" src="{{asset('assets/Admin/assets/img/users/4.jpg')}}">
												</div>
											</td>
											<td class="pb-0">
												<div class="d-flex align-middle ms-3">
							...
							<div class="card custom-card">
								<div class="card-body">
									<div class="row row-sm">
										...
										<div class="col-6">
											<img src="{{asset('assets/Admin/assets/img/pngs/work.png')}}" alt="image" class="best-emp">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col col-auto">
											<div class="mt-3">
												<div class="">
													<img alt="" class="ht-50" src="{{asset('assets/Admin/assets/img/media/project-logo.png')}}">
												</div>
											</div>
										</div>
									</div>
