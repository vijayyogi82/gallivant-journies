...
<div class="container-fluid">
   <div class="card">
      <div class="card-body">
      <form class="form-ad"  method="POST" action="{{ route('tourdetail.store') }}">
       @csrf
         <div class="row">
            <div class="col-md-4">
               <div class="mb-3">
...
<div class="tab-pane fade accordion-item" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
   ...
   <div id="collapseThree" class="accordion-collapse collapse d-lg-block" aria-labelledby="headingThree" data-bs-parent="#myTabContent">
      ...
      <!--<img src="{{ asset('storage/tourdetailsimage/'. $gallary->image) }}"  height="150px", width ="150px">-->
      <!--@endforeach-->
         <div class="form-group text-center">
            <button type="submit" class="btn btn-success btn-sm">Submit</button>
         </div>
...
<script>
    ...
    days.find("input").val("");
  //  $("#settextareass").append(days.html());
